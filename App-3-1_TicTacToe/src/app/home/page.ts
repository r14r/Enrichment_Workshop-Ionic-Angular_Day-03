...
export class Page {
	...
	move(id: string) {
		...
		if (this.human) {
			if (document.getElementById(id).innerHTML === '') {
				...
				this.data[Number(id.substr(0, 1))][Number(id.substr(1, 2))] =
					'X';
				this.human = false;
				this.winner('check');
				if (this.gameOver) {
			...
			if (this.mode === '2P') {
				if (document.getElementById(id).innerHTML === '') {
					...
					this.data[Number(id.substr(0, 1))][
						Number(id.substr(1, 2))
					] = 'O';
					this.human = true;
				}
			}
	...
	aiTurn() {
		...
		document.getElementById(
			String(bestMove.x) + String(bestMove.y)
		).innerHTML = 'O';
	}
		...
		if (mode === 'minimax') {
			...
			if (
				(this.data[0][0] === this.data[0][1] &&
					this.data[0][1] === this.data[0][2] &&
					this.data[0][2] === player) ||
				(this.data[1][0] === this.data[1][1] &&
					this.data[1][1] === this.data[1][2] &&
					this.data[1][2] === player) ||
				(this.data[2][0] === this.data[2][1] &&
					this.data[2][1] === this.data[2][2] &&
					this.data[2][2] === player) ||
				(this.data[0][0] === this.data[1][0] &&
					this.data[1][0] === this.data[2][0] &&
					this.data[2][0] === player) ||
				(this.data[0][1] === this.data[1][1] &&
					this.data[1][1] === this.data[2][1] &&
					this.data[2][1] === player) ||
				(this.data[0][2] === this.data[1][2] &&
					this.data[1][2] === this.data[2][2] &&
					this.data[2][2] === player) ||
			...
			if (
				...
				this.alertX();
				this.scoreX += 1;
				document.getElementById('score-x-label').innerHTML = String(
					this.scoreX
				);
			...
			if (
				...
				this.alertO();
				this.scoreO += 1;
				document.getElementById('score-o-label').innerHTML = String(
					this.scoreO
				);
				document.getElementById('next-label').innerHTML = '-';
				this.gameOver = true;
			...
			if (availableSpots === 0) {
				...
				this.alertT();
				this.scoreT += 1;
				document.getElementById('score-t-label').innerHTML = String(
					this.scoreT
				);
				document.getElementById('next-label').innerHTML = '-';
				this.gameOver = true;
