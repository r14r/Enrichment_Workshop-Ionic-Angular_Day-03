...
const routes: Routes = [
	...
	},
	{
		path: 'demo',
		loadChildren: () =>
			import('./pages.base/demo/pages/module').then(
				(m) => m.DemoPageModule
			),
	},
	{
	...
	},
	{
		...
		loadChildren: () =>
			import('./pages/countries-of-the-world/pages/home/module').then(
				(m) => m.CountriesOfTheWorldPageModule
			),
	},
	{
		path: 'multi-level-sidemenu',
		loadChildren: () =>
			import('./pages/multi-level-sidemenu/pages/home/module').then(
				(m) => m.MultiLevelSidemenuPageModule
			),
	},
	{
		path: 'weather',
		loadChildren: () =>
			import('./pages/weather/pages/home/module').then(
				(m) => m.WeatherPageModule
			),
	},
	{
		path: 'game/connect4/1',
		loadChildren: () =>
			import('./blocks/connect4/step1/pages/module').then(
				(m) => m.Connect4Step1PageModule
			),
	},
	{
		path: 'game/connect4/2',
		loadChildren: () =>
			import('./blocks/connect4/step2/pages/module').then(
				(m) => m.Connect4Step2PageModule
			),
	},

	{
		path: 'game/connect4/demo1',
		loadChildren: () =>
			import('./blocks/connect4/demo1/pages/module').then(
				(m) => m.Connect4Demo1PageModule
			),
	},
	{
		path: 'game/connect4/demo2',
		loadChildren: () =>
			import('./blocks/connect4/demo2/pages/module').then(
				(m) => m.Connect4Demo2PageModule
			),
	},
	{
		path: 'game/connect4/demo3',
		loadChildren: () =>
			import('./blocks/connect4/demo3/pages/module').then(
				(m) => m.Connect4Demo3PageModule
			),
	},
	{
		path: 'game/connect4/demo4',
		loadChildren: () =>
			import('./blocks/connect4/demo4/pages/module').then(
				(m) => m.Connect4Demo4PageModule
			),
	},
	{
		path: 'demo',
